...
public class VisualListModel_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.HierarchyBoundsListener", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.HierarchyListener", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.MouseWheelListener", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.beans.VetoableChangeListener", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Predicate", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.swing.event.PopupMenuListener", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
  }
