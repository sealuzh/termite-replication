...
public class ForeignKeyConstraint_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.Comparator", false, ForeignKeyConstraint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, ForeignKeyConstraint_ESTest_scaffolding.class.getClassLoader()));
