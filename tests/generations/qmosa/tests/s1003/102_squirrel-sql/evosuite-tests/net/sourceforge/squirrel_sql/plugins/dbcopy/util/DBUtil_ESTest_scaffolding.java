...
public class DBUtil_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.ContainerListener", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.InputMethodListener", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
