...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder(";Dvddo", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      doReturn(0L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = new ArtificialPhd("{9XOu/N", nucleotideSequence0, qualitySequence0, 0);
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      DefaultPhd defaultPhd0 = new DefaultPhd("r", (NucleotideSequence) null, qualitySequence0, (PositionSequence) null, map0);
      PhdBuilder phdBuilder0 = new PhdBuilder(defaultPhd0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(3266, 3266);
      assertSame(phdBuilder0, phdBuilder1);
  }
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("-PuwxdR/tnJm ,Q", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks();
      Phd phd0 = phdBuilder1.build();
      assertEquals("-PuwxdR/tnJm ,Q", phd0.getId());
  }
  ...
  */
  ...
  public void test10()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("znC", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((int) (short)0, 947);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test15()  throws Throwable  {
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("sequence can not be null", (NucleotideSequence) null, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test19()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("+svcD}!-~cMUF[jzc@", nucleotideSequence0, qualitySequence0);
