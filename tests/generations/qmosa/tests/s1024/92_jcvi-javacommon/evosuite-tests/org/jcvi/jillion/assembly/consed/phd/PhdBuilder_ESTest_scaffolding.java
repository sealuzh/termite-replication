...
public class PhdBuilder_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PhdBuilder_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.jcvi.jillion.core.qual.RunLengthEncodedQualityCodec$RunLengthIterator",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.function.Consumer", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
