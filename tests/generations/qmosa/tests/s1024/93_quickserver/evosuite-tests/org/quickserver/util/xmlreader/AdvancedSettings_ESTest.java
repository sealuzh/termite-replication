...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  */
  ...
  public void test05()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesConnectionTime((-3505));
  ...
  */
  ...
  public void test41()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        advancedSettings0.setCharset("org.quicksirver.net.server.impl.OptimisticClientIdentifier");
        fail("Expecting exception: UnsupportedCharsetException");
      
      } catch(UnsupportedCharsetException e) {
         //
         // org.quicksirver.net.server.impl.OptimisticClientIdentifier
         //
  ...
  */
  ...
  public void test43()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketTrafficClass("R*now32N~s13");
      String string0 = advancedSettings0.toXML("0s9p%");
      ...
      assertEquals("0s9p%<advanced-settings>\n0s9p%\t<charset>ISO-8859-1</charset>\n0s9p%\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n0s9p%\t<byte-buffer-size>65536</byte-buffer-size>\n0s9p%\t<backlog>0</backlog>\n0s9p%\t<socket-linger>-1</socket-linger>\n0s9p%\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n0s9p%\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n0s9p%\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n0s9p%\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n0s9p%\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n0s9p%\t<performance-preferences-latency>0</performance-preferences-latency>\n0s9p%\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n0s9p%\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n0s9p%\t<client-socket-traffic-class>R*now32N~s13</client-socket-traffic-class>\n0s9p%</advanced-settings>\n", string0);
  }
  ...
  */
  ...
  public void test45()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesLatency((-1729));
      int int0 = advancedSettings0.getPerformancePreferencesLatency();
  ...
  */
  ...
  public void test52()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setMaxThreadsForNioWrite((-3391));
      int int0 = advancedSettings0.getMaxThreadsForNioWrite();
