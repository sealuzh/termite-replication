...
public class ClientMsgReceiver_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.InputMethodListener", false, ClientMsgReceiver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.lang.ThreadGroup", false, ClientMsgReceiver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, ClientMsgReceiver_ESTest_scaffolding.class.getClassLoader()));
  }
