...
public class JSJshop_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.ComponentListener", false, JSJshop_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.MouseWheelListener", false, JSJshop_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, JSJshop_ESTest_scaffolding.class.getClassLoader()));
  }
