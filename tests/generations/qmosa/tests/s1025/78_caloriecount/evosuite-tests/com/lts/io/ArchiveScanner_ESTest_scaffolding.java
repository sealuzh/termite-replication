...
public class ArchiveScanner_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.util.Enumeration", false, ArchiveScanner_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, ArchiveScanner_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, ArchiveScanner_ESTest_scaffolding.class.getClassLoader()));
  }
