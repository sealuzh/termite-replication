...
public class RecordTypeMessage_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.time.Clock", false, RecordTypeMessage_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.time.temporal.TemporalField", false, RecordTypeMessage_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.time.temporal.TemporalUnit", false, RecordTypeMessage_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, RecordTypeMessage_ESTest_scaffolding.class.getClassLoader()));
  }
