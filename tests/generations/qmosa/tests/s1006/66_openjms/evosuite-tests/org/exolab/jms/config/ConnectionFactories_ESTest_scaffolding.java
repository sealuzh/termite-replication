...
public class ConnectionFactories_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, ConnectionFactories_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, ConnectionFactories_ESTest_scaffolding.class.getClassLoader()));
  }
