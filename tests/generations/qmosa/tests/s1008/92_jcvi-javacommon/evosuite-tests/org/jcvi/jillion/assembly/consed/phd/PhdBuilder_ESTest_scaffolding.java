...
public class PhdBuilder_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.time.temporal.TemporalField", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiConsumer", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
