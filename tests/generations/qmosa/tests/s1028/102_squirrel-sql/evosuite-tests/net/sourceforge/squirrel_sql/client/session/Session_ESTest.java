...
public class Session_ESTest extends Session_ESTest_scaffolding {
  ...
  */
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = "RQI^$>l<";
      String string1 = "net.sourceforge.squirrel_sql.client.session.mainpanel.SQLPanel$CopyLastButton";
      Session session0 = null;
      try {
        session0 = new Session((IApplication) null, sQLDriver0, sQLAlias0, sQLConnection0, "", "net.sourceforge.squirrel_sql.client.session.mainpanel.SQLPanel$CopyLastButton", uidIdentifier0);
