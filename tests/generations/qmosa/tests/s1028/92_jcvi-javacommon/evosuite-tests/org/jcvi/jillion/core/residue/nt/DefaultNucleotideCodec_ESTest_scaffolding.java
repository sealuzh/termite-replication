...
public class DefaultNucleotideCodec_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, DefaultNucleotideCodec_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, DefaultNucleotideCodec_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Predicate", false, DefaultNucleotideCodec_ESTest_scaffolding.class.getClassLoader()));
  }
