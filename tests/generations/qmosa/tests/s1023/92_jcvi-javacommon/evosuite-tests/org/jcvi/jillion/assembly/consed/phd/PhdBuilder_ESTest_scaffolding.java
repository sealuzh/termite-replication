...
public class PhdBuilder_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jcvi.jillion.core.pos.PositionSequence", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
