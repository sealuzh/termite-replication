...
public class Library_ESTest extends Library_ESTest_scaffolding {
  ...
  /**
  //Test case number: 0
  /*Coverage entropy=1.6505781318024422
  */
  @Test(timeout = 4000)
  public void test0()  throws Throwable  {
      ...
      library0.loadFromDirectory("r97Y}");
      library0.loadFromDirectory("u_jL");
      ...
      EvoSuiteFile evoSuiteFile1 = new EvoSuiteFile("r97Y}");
      ...
      library0.getDictionaries();
      library0.loadFromDirectory(" milliseconds.");
      EvoSuiteFile evoSuiteFile2 = new EvoSuiteFile("u_jL");
      FileSystemHandling.appendStringToFile(evoSuiteFile2, " milliseconds.");
      library0.getDictionaries();
