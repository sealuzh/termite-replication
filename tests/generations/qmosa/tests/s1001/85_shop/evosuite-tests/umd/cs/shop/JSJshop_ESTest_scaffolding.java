...
public class JSJshop_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.HierarchyBoundsListener", false, JSJshop_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.InputMethodListener", false, JSJshop_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Predicate", false, JSJshop_ESTest_scaffolding.class.getClassLoader()));
  }
