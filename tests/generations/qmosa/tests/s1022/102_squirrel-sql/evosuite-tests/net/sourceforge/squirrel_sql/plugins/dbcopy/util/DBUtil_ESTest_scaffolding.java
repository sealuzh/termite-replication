...
public class DBUtil_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.ComponentListener", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.HierarchyBoundsListener", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.MouseWheelListener", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Connection", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.swing.event.AncestorListener", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
