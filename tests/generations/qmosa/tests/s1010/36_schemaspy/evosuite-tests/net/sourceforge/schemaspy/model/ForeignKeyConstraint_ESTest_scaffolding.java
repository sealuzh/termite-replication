...
public class ForeignKeyConstraint_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ForeignKeyConstraint_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.sourceforge.schemaspy.util.ConsolePasswordReader",
      "net.sourceforge.schemaspy.util.PasswordReader",
      ...
      "net.sourceforge.schemaspy.util.PasswordReader$Masker",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, ForeignKeyConstraint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.DatabaseMetaData", false, ForeignKeyConstraint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSet", false, ForeignKeyConstraint_ESTest_scaffolding.class.getClassLoader()));
