...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("('MsjiSK", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("", nucleotideSequence0, qualitySequence0);
      phdBuilder0.fakePeaks(2509, 2509);
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("ba", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(6, (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test08()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("OdJw8kjI>p{ZkmfVC-", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-243), 3705);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test09()  throws Throwable  {
      ...
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(nucleotideSequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("ea:Lv,e/%\"", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("54B]w", nucleotideSequence0, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
