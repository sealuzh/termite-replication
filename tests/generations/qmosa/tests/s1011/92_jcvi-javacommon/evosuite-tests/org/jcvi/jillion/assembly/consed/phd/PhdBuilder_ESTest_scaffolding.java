...
public class PhdBuilder_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.time.temporal.TemporalAmount", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.time.temporal.TemporalUnit", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, PhdBuilder_ESTest_scaffolding.class.getClassLoader()));
