...
public class VisualListModel_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.sun.media.jai.codec.FPXDecodeParam", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.sun.media.jai.codec.SeekableStream", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.ContainerListener", false, VisualListModel_ESTest_scaffolding.class.getClassLoader()));
