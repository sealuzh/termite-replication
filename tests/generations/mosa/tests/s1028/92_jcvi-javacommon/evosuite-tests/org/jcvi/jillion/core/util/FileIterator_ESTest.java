...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  /**
  //Test case number: 0
  /*Coverage entropy=3.3431391460919326
  */
  @Test(timeout = 4000)
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      MockFile.createTempFile(".X9eq3fsfGiy-", ".X9eq3fsfGiy-", (File) mockFile0);
      MockFile mockFile1 = new MockFile("x5Uqp", "E'V(b%");
  ...
  */
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      MockFile.createTempFile("tNKWHrYyI~|v'", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("P26vx.MtMzLa@Q");
      MockFile.createTempFile("P26vx.MtMzLa@Q", "P26vx.MtMzLa@Q", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.next();
  ...
  */
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      File file0 = MockFile.createTempFile("o9`=y/<FUYYH", "o9`=y/<FUYYH");
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test28()  throws Throwable  {
      MockFile mockFile0 = new MockFile("or.jcv.jillion.core.util.LIFOQueue", "or.jcv.jillion.core.util.LIFOQueue");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      // Undeclared exception!
      try { 
        fileIterator_FileIteratorBuilder0.build();
