...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("Nq[F)+Vf7</Nq[F)+Vf7</Nq[F)+Vf7<0Nq[F)+Vf7<");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator$DirectoryFileFilter");
      MockFile mockFile0 = new MockFile("Nq[F)+Vf7<", "Nq[F)+Vf7<");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Nq[F)+Vf7<", "Nq[F)+Vf7<");
      MockFile.createTempFile("Nq[F)+Vf7<", "Nq[F)+Vf7<", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.next();
  ...
  */
  ...
  public void test05()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("H}`3^JHVR:>{#dB/H}`3^JHVR:>{#dB/H}`3^JHVR:>{#dB0H}`3^JHVR:>{#dB");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "4Qe/");
      MockFile mockFile0 = new MockFile("H}`3^JHVR:>{#dB", "H}`3^JHVR:>{#dB");
      MockFile.createTempFile("H}`3^JHVR:>{#dB", "H}`3^JHVR:>{#dB", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.getNextFile();
      assertNotNull(file0);
  ...
  */
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      MockFile.createTempFile(".y!`'(xng\"RGGW", ".y!`'(xng\"RGGW");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
