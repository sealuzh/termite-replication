...
public class Session_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Session_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.sourceforge.squirrel_sql.client.session.parser.kernel.ParsingFinishedListener",
      ...
      "net.sourceforge.squirrel_sql.client.session.parser.ParserEventsProcessor$2",
      "net.sourceforge.squirrel_sql.client.session.parser.ParserEventsProcessor$1",
      ...
      "net.sourceforge.squirrel_sql.client.session.parser.ParserEventsProcessor",
