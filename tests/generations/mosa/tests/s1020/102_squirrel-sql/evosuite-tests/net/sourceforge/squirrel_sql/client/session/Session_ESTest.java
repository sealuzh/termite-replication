...
public class Session_ESTest extends Session_ESTest_scaffolding {
  ...
  */
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        session0 = new Session((IApplication) null, sQLDriver0, sQLAlias0, (SQLConnection) null, "net.sourceforgewsquirrel_sql.client.session.Session$SQLConnectionListener", "net.sourceforgewsquirrel_sql.client.session.Session$SQLConnectionListener", (IIdentifier) null);
