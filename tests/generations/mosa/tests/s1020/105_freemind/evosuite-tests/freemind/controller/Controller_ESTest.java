...
public class Controller_ESTest extends Controller_ESTest_scaffolding {
  ...
  */
  ...
  public void test6()  throws Throwable  {
      JRadioButtonMenuItem jRadioButtonMenuItem0 = new JRadioButtonMenuItem("}3*r.]3X=K43Y");
      Color color0 = Color.yellow;
      try { 
        Controller.showCommonJColorChooserDialog(jRadioButtonMenuItem0, "}3*r.]3X=K43Y", color0);
