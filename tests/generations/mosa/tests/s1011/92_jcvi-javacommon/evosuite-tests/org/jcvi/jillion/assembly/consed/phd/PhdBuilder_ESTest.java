...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      ArtificialPhd artificialPhd0 = new ArtificialPhd((String) null, nucleotideSequence0, qualitySequence0, (-52));
      Map<String, String> map0 = artificialPhd0.getComments();
      ArtificialPhd artificialPhd1 = ArtificialPhd.createNewbler454Phd((String) null, nucleotideSequence0, qualitySequence0, map0);
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(1L, 5567L).when(qualitySequence0).getLength();
      ...
      doReturn(5567L).when(positionSequence0).getLength();
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder("FuH-Q!&S*1", nucleotideSequence1, qualitySequence0);
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("FuH-Q!&S*1", nucleotideSequence0, qualitySequence1);
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      doReturn(1L).when(nucleotideSequence0).getLength();
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("peak spacing must be >0", nucleotideSequence0, (QualitySequence) null);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(362L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("RiPF5@nK1:s} v4o2u", nucleotideSequence0, qualitySequence0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ...
      Map<String, String> map0 = artificialPhd0.getComments();
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("RiPF5@nK1:s} v4o2u", nucleotideSequence0, qualitySequence0, positionSequence0, defaultChannelGroup0, map0);
  ...
  */
  ...
  public void test08()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn((-1001L)).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
  ...
  */
  ...
  public void test09()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("Lj[\"4kjrl", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-1443), (-1443));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test10()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("kzfmQb<RY5YdFc0U", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(128, (-1));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("Lg7geMW+ff", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test12()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("/SHw88+AaX'zF<", nucleotideSequence0, qualitySequence0);
      phdBuilder0.fakePeaks();
      Phd phd0 = phdBuilder0.build();
      assertEquals("/SHw88+AaX'zF<", phd0.getId());
  }
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("28^n)C", nucleotideSequence0, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test14()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("|(AhJ", (NucleotideSequence) null, qualitySequence0);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test19()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("-tH_p;u_%^ {e", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test21()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("eqmQJmba", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test25()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("wwlG+s@", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test26()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(818, 818);
      assertSame(phdBuilder1, phdBuilder0);
  }
