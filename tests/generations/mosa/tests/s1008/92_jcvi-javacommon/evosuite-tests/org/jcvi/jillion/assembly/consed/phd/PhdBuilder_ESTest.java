...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(1342L).when(nucleotideSequence0).getLength();
      byte[] byteArray0 = new byte[1];
      byteArray0[0] = (byte)97;
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd((String) null, nucleotideSequence0, qualitySequence0, map0);
      ...
      DefaultChannel defaultChannel0 = new DefaultChannel(byteArray1, shortArray0);
      ...
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("y", "y", byteArray0, positionSequence0, defaultChannelGroup0, map0);
  ...
  */
  ...
  public void test01()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      DefaultPhd defaultPhd0 = new DefaultPhd("org.jcvi.jillion.core.qual.RunLengthEncodedQualityCodec$Metrics", nucleotideSequence0, qualitySequence0, (PositionSequence) null, (Map<String, String>) null);
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      doReturn(1342L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(3479L).when(qualitySequence0).getLength();
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      doReturn(1342L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(1342L).when(qualitySequence0).getLength();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder("$4j~0&tcXpR)/;", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test05()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1365L).when(nucleotideSequence0).getLength();
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("E=|'@I&a{", nucleotideSequence0, (QualitySequence) null, map0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("Vgy<TBR@P,*1'd1*9j", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(13, (-417));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("fpC/ns!'TUdS", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test12()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("]s]*_!^?^n^5Tk%bta", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("5'h", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test14()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("fcsj", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("|.:6qgr'BqU0@=", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test18()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder(" Q=}c%sB<O", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test22()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("[=`4x8j(wbK\u0006?'", nucleotideSequence0, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("y/(s&I`Qe[-/for4", (NucleotideSequence) null, qualitySequence0);
        fail("Expecting exception: NullPointerException");
