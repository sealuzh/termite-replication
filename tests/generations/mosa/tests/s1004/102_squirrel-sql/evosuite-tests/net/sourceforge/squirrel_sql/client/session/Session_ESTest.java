...
public class Session_ESTest extends Session_ESTest_scaffolding {
  ...
  */
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        session0 = new Session((IApplication) null, sQLDriver0, sQLAlias0, (SQLConnection) null, "The 'data' array must have length == 3.", "The 'data' array must have length == 3.", uidIdentifier0);
