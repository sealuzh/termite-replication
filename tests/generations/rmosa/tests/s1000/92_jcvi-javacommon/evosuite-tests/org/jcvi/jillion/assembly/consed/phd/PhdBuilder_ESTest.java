...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(24L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(692L).when(qualitySequence0).getLength();
      ...
      doReturn(692L, 692L, 692L, 692L).when(qualitySequence2).getLength();
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder("S+deAxn.8", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      doReturn(0L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("G)+\"PbuPf@xix", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(1075, 1075);
  ...
  */
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(2145199090, 0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test10()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2832L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2561L).when(qualitySequence0).getLength();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("'?J2q,#z_my|3e[V#", nucleotideSequence0, qualitySequence0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      DefaultPhd defaultPhd0 = new DefaultPhd("'?J2q,#z_my|3e[V#", nucleotideSequence0, qualitySequence0, positionSequence0);
  ...
  */
  ...
  public void test11()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2041L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2041L, 2041L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("u[Z'1RKFq!Gq", nucleotideSequence0, qualitySequence0);
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2041L).when(nucleotideSequence1).getLength();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = new ArtificialPhd("u[Z'1RKFq!Gq", nucleotideSequence1, qualitySequence1, 1421);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
  ...
  */
  ...
  public void test12()  throws Throwable  {
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1797L).when(nucleotideSequence0).getLength();
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      doReturn(2041L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2041L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("u[Z'1RKFq!Gq", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      doReturn(24L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(1338L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test18()  throws Throwable  {
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("97?@u8VeP kS_b\u0000#H", (NucleotideSequence) null, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test20()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("N:16/sl\"AG~", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test21()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("J-w4", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test24()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("Uxj=&^XQHsdO3=*A", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
