...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("~/5CJq0(</,Jx*a0 !0");
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile.createTempFile("3lUD..`'WlUk>ZB(iW", "3lUD..`'WlUk>ZB(iW", (File) mockFile1);
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      File file0 = MockFile.createTempFile("a*+qQwa", "VR2{]`m^_TB", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      file0.delete();
  ...
  */
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      MockFile.createTempFile("V62{]`m5^_TB", "", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      MockFile.createTempFile("W5uP>i(<h>]2 d", "W5uP>i(<h>]2 d", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      MockFile.createTempFile("V62{]`m5^_TB", "V62{]`m5^_TB", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("org.jcvi.jillion.core.util.LIFOQueue", "3lUD..`'WlUk>ZB(iW");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder(mockFile0);
      File file0 = MockFile.createTempFile("3lUD..`'WlUk>ZB(iW", "V62{]`m5^_TB");
      MockFile.createTempFile("org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator$DirectoryFileFilter", "org.jcvi.jillion.core.util.LIFOQueue", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test15()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder(mockFile0);
      MockFile.createTempFile(".A}Ka,ad!c{U?", "3lUVDC.`'WlUk>ZBiW", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
  ...
  */
  ...
  public void test20()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      MockFile.createTempFile("a*+qQwa", "", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.includeDirectories(true);
