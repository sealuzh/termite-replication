...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(1424L).when(qualitySequence0).getLength();
      ...
      doReturn(834L).when(nucleotideSequence1).getLength();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd1 = ArtificialPhd.createNewbler454Phd("4Lo52T_00U;Q", nucleotideSequence1, qualitySequence1);
  ...
  */
  ...
  public void test04()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1439L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("4Lo52T_00U;Q", nucleotideSequence0, qualitySequence0);
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      DefaultPhd defaultPhd0 = new DefaultPhd("org.jcvi.jillion.internal.core.io.RandomAccessFileInputStream", nucleotideSequence1, (QualitySequence) null, positionSequence0, map0);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      DefaultPhd defaultPhd0 = new DefaultPhd("tut", (NucleotideSequence) null, qualitySequence0, (PositionSequence) null, hashMap0);
      PhdBuilder phdBuilder0 = new PhdBuilder(defaultPhd0);
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("B2qw_Lr63,U)", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
  }
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      DefaultPhd defaultPhd0 = new DefaultPhd("length can not be less than 0", nucleotideSequence0, qualitySequence0, (PositionSequence) null);
      List<PhdReadTag> list0 = defaultPhd0.getReadTags();
      DefaultPhd defaultPhd1 = new DefaultPhd("s&x-", nucleotideSequence0, qualitySequence0, (PositionSequence) null, map0, (List<PhdWholeReadItem>) null, list0);
  ...
  */
  ...
  public void test08()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("iOwQqN\"Sn", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(15, 15);
      Phd phd0 = phdBuilder1.build();
      assertEquals("iOwQqN\"Sn", phd0.getId());
  }
  ...
  */
  ...
  public void test10()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("ji*QEg.ss2", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(603, (-397));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-1792), (-1792));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test12()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1832L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((-2011L)).when(qualitySequence0).getLength();
      ArtificialPhd artificialPhd0 = new ArtificialPhd("|dao7qS", nucleotideSequence0, qualitySequence0, 1098);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(1424L).when(qualitySequence0).getLength();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("4L5T_00U;Q", nucleotideSequence0, qualitySequence0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      doReturn(0L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("huD^7PCy+Aj", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test18()  throws Throwable  {
      ...
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("4Lo52T_00U;Q", nucleotideSequence1, qualitySequence1, positionSequence0, defaultChannelGroup0, map0);
  ...
  */
  ...
  public void test19()  throws Throwable  {
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((-173L)).when(qualitySequence0).getLength();
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(nucleotideSequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("^$O(u['Bq^'jCu", nucleotideSequence0, qualitySequence0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test21()  throws Throwable  {
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("L#\b7vq]yc", (NucleotideSequence) null, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("fwi%w@i4@Q;xr8}", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test26()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("d@?ZqvAu%{=K0.", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
