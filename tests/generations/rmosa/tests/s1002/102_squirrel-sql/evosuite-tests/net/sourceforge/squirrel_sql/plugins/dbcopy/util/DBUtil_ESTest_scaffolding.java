...
public class DBUtil_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("net.sourceforge.squirrel_sql.client.session.schemainfo.SchemaInfoUpdateListener", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
