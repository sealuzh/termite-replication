...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(372L).when(nucleotideSequence0).getLength();
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(704L).when(qualitySequence0).getLength();
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("~oSrm_0Kqp", nucleotideSequence0, qualitySequence0, map0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      DefaultPhd defaultPhd0 = new DefaultPhd("~oSrm_0Kqp", nucleotideSequence1, qualitySequence0, positionSequence0);
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder("9.zEk74i{iI%", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("`32xJew0Y-msXZ", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      DefaultPhd defaultPhd0 = new DefaultPhd("", (NucleotideSequence) null, qualitySequence1, positionSequence0);
      PhdBuilder phdBuilder0 = new PhdBuilder(defaultPhd0);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd(":9UHq.)WG}88Xc1", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("I6JQD[6g]ebyt3K,zOd", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(2068, 2068);
      Phd phd0 = phdBuilder1.build();
      assertEquals("I6JQD[6g]ebyt3K,zOd", phd0.getId());
  }
  ...
  */
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-3089), (-3089));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test12()  throws Throwable  {
      ...
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(372L).when(qualitySequence1).getLength();
  ...
  */
  ...
  public void test18()  throws Throwable  {
      ...
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("~oSrm_0Kqp", nucleotideSequence0, qualitySequence0, map0);
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(372L, 372L, 372L, 372L).when(qualitySequence1).getLength();
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      ...
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("Z'S", nucleotideSequence1, qualitySequence1, positionSequence0, defaultChannelGroup0);
  ...
  */
  ...
  public void test19()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1163L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test21()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("`z]=-qu", (NucleotideSequence) null, qualitySequence0);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("FU", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test24()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test26()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("yYP[38vS*7]", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
