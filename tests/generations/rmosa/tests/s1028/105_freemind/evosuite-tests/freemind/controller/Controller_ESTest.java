...
public class Controller_ESTest extends Controller_ESTest_scaffolding {
  ...
  */
  ...
  public void test4()  throws Throwable  {
      JList<JComboBox<DefaultListCellRenderer>> jList0 = new JList<JComboBox<DefaultListCellRenderer>>();
      Color color0 = jList0.getSelectionBackground();
      try { 
        Controller.showCommonJColorChooserDialog(jList0, " C=c/l'", color0);
