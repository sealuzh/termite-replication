...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test05()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      File file0 = MockFile.createTempFile("M~Oj5$&%'(nz;:f}", "M~Oj5$&%'(nz;:f}");
      file0.setLastModified(0L);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file1 = fileIterator0.getNextFile();
      assertNotNull(file1);
      assertEquals("/tmp/M~Oj5$&%'(nz;:f}0M~Oj5$&%'(nz;:f}", file1.toString());
  }
  ...
  */
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      File file0 = MockFile.createTempFile("o]em5<u-ZlJ.", "", (File) mockFile0);
      file0.createNewFile();
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      MockFile.createTempFile("o]em5<u-ZlJ.", "", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals("org.jcvi.jillion.core.util.FileIterator$BreadthFirstFileIteratorBuilder0org.jcvi.jillion.core.util.FileIterator$BreadthFirstFileIteratorBuilder", file0.getName());
  }
  ...
  */
  ...
  public void test17()  throws Throwable  {
      File file0 = MockFile.createTempFile("pN:*{w", "pN:*{w");
  ...
  */
  ...
  public void test18()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      MockFile.createTempFile("org.jcvi.jillion.core.util.FIFOQueue", "\"4", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertTrue(fileIterator0.hasNext());
