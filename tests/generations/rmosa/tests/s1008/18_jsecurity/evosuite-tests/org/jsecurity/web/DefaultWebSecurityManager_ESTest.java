...
public class DefaultWebSecurityManager_ESTest extends DefaultWebSecurityManager_ESTest_scaffolding {
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager(simpleAccountRealm0);
      defaultWebSecurityManager0.setSessionMode("jsecurity");
      defaultWebSecurityManager0.setSessionIdCookieMaxAge((-1794641339));
      assertEquals("jsecurity", defaultWebSecurityManager0.getSessionMode());
  }
  ...
  */
  ...
  public void test25()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionMode("e#dbpZS'&");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid sessionMode [e#dbpZS'&].  Allowed values are public static final String constants in the org.jsecurity.web.DefaultWebSecurityManager class: 'http' or 'jsecurity', with 'http' being the default.
         //
         verifyException("org.jsecurity.web.DefaultWebSecurityManager", e);
      }
  }
