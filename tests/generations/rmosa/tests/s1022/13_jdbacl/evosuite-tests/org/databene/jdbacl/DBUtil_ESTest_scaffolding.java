...
public class DBUtil_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.concurrent.ThreadFactory", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.databene.jdbacl.model.CompositeDBObject", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.firebirdsql.gds.impl.GDSHelper", false, DBUtil_ESTest_scaffolding.class.getClassLoader()));
