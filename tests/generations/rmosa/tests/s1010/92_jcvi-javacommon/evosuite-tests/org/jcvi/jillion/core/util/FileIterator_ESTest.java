...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/1@LUJ@7hDRju");
  ...
  */
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      MockFile mockFile1 = new MockFile(mockFile0, "1@LUJ@7hDRju");
  ...
  */
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("4]s WL");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      MockFile mockFile1 = new MockFile("4]s WL", "4]s WL");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.includeDirectories(true);
      mockFile1.mkdirs();
      mockFile1.setLastModified(0L);
      MockFile mockFile2 = new MockFile(mockFile0, "'L^");
      mockFile2.mkdirs();
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder1.build();
      File file0 = fileIterator0.getNextFile();
      assertNotNull(file0);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      File file0 = fileIterator0.getNextFile();
      assertNotNull(file0);
      assertEquals("/home/ubuntu/replication/scripts/projects/92_jcvi-javacommon/4]s WL/4]s WL", file0.toString());
  }
  ...
  */
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("4]s WL");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("4]s WL/4]s WL/}^ AVcnAp4|");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "i9Zm.-W.KR?=");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.includeDirectories(true);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder1.build();
      File file0 = fileIterator0.getNextFile();
      assertNotNull(file0);
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = MockFile.createTempFile("SLE|", (String) null, (File) mockFile0);
  ...
  */
  ...
  public void test17()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      MockFile.createTempFile(".x%ldD", "-06u^`B`;1", (File) mockFile0);
