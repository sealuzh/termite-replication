...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test02()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(538L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2532L).when(qualitySequence0).getLength();
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      LinkedList<ArtificialPhd> linkedList0 = new LinkedList<ArtificialPhd>();
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      LinkedList<ArtificialPhd> linkedList1 = new LinkedList<ArtificialPhd>();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("]KHJ", nucleotideSequence0, qualitySequence0, (Map<String, String>) hashMap0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      ...
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("sequence can not be null", nucleotideSequence0, qualitySequence0, positionSequence0, defaultChannelGroup0, hashMap0);
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      doReturn(538L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(538L).when(qualitySequence0).getLength();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("]KHJ", nucleotideSequence0, qualitySequence0, (Map<String, String>) hashMap0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      LinkedList<PhdWholeReadItem> linkedList0 = new LinkedList<PhdWholeReadItem>();
  ...
  */
  ...
  public void test05()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2014L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("b", nucleotideSequence0, qualitySequence0, (Map<String, String>) null);
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(1968526677, 1968526677);
  ...
  */
  ...
  public void test08()  throws Throwable  {
      ...
      doReturn(538L).when(nucleotideSequence0).getLength();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd((String) null, nucleotideSequence0, (QualitySequence) null, (Map<String, String>) hashMap0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test09()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("#*Bflm!x", nucleotideSequence0, qualitySequence0, (Map<String, String>) hashMap0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      Locale locale0 = Locale.FRENCH;
      locale0.getUnicodeLocaleKeys();
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
  ...
  */
  ...
  public void test10()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("wnL!&prL23", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("\"kb(JYAE", nucleotideSequence0, qualitySequence0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("WlQ.ogzqU=E]yAz<Hi", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test14()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("(h+6uSvd0/T", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test19()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("\"RY-C7a~L3C'kTe$f", nucleotideSequence0, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test21()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(2116360696, 127);
      assertSame(phdBuilder0, phdBuilder1);
  }
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-2609), (-2433));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test26()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(655, 655);
      assertSame(phdBuilder1, phdBuilder0);
  }
  ...
  */
  ...
  public void test28()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("\"kb(JYAE", nucleotideSequence0, qualitySequence0);
