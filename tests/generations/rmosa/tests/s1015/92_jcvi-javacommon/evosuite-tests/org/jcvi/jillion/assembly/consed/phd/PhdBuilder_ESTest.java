...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(65544L).when(nucleotideSequence0).getLength();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("^19}%UoT\" h1Q(lh$.", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(743L, 3917L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("chromatoram can not b null", nucleotideSequence1, qualitySequence0);
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("chromatoram can not b null", nucleotideSequence0, (QualitySequence) null);
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("!Scv(", nucleotideSequence1, qualitySequence0, map0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ...
      defaultChannelGroup0.equals(object0);
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("!Scv(", nucleotideSequence2, qualitySequence0, positionSequence0, defaultChannelGroup0, map0);
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(743L).when(nucleotideSequence1).getLength();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("chromatogram can not be null", nucleotideSequence1, (QualitySequence) null);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("}az+BH#?Vsbr#D", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test12()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(762L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("O\"Pz?*9D<uA2", nucleotideSequence0, qualitySequence0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(nucleotideSequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("raU=W \"8", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test14()  throws Throwable  {
      ...
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(1364, 1364);
  ...
  */
  ...
  public void test15()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("8^T>6,$TU0w|VY", nucleotideSequence0, qualitySequence0);
      Phd phd0 = phdBuilder0.build();
      assertEquals("8^T>6,$TU0w|VY", phd0.getId());
  }
  ...
  */
  ...
  public void test17()  throws Throwable  {
      ...
      doReturn(0L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("y]lWMJ", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test19()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("ww,5/", nucleotideSequence0, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test22()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("number of entries must be >=0", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder(">ztiTvLU", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test24()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(1, 292);
      assertSame(phdBuilder0, phdBuilder1);
  }
  ...
  */
  ...
  public void test26()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder(":1*`H<}SeV!*jh", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-479), (-479));
        fail("Expecting exception: IllegalArgumentException");
