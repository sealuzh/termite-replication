...
public class Session_ESTest extends Session_ESTest_scaffolding {
  ...
  */
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        session0 = new Session((IApplication) null, sQLDriver0, sQLAlias0, sQLConnection0, "Only one custom query tokenizer can be installed.  Current tokenizer is ", "3#q_uxd", uidIdentifier0);
