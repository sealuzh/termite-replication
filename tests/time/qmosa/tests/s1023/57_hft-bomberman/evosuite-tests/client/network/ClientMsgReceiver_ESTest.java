...
public class ClientMsgReceiver_ESTest extends ClientMsgReceiver_ESTest_scaffolding {
  ...
  */
  ...
  public void test4()  throws Throwable  {
      ...
      ClientMsgReceiver clientMsgReceiver0 = new ClientMsgReceiver(mockSocket0, (BomberClient) null);
      BatchUpdateException batchUpdateException0 = new BatchUpdateException("~ l=}Kd4a4", "$$dU_9{.!QTP6|lK", (int[]) null);
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("~ l=}Kd4a4", batchUpdateException0);
      SQLDataException sQLDataException0 = new SQLDataException("KB`[[K{.A", "", 3082, sQLInvalidAuthorizationSpecException0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test5()  throws Throwable  {
      MockSocket mockSocket0 = new MockSocket();
      ClientMsgReceiver clientMsgReceiver0 = new ClientMsgReceiver(mockSocket0, (BomberClient) null);
      JoinAckMsg joinAckMsg0 = new JoinAckMsg(false, 100);
      // Undeclared exception!
      try { 
