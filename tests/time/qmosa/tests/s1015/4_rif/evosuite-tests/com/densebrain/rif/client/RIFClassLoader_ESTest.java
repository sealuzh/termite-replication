...
public class RIFClassLoader_ESTest extends RIFClassLoader_ESTest_scaffolding {
  ...
  */
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        rIFClassLoader0.registerClass("0PE.W:Qb.A \"Ple", byteArray1);
  ...
  */
  ...
  public void test2()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        rIFClassLoader0.registerClass("^[Av~ZS\"yv,", (byte[]) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test3()  throws Throwable  {
      ...
      rIFClassLoader0.clearAssertionStatus();
      byteArray0[3] = (byte)1;
      rIFClassLoader0.setPackageAssertionStatus("{wV:OY!w_", true);
      byteArray0[4] = (byte) (-30);
      byteArray0[5] = (byte)65;
      rIFClassLoader0.getParent();
      rIFClassLoader0.setClassAssertionStatus("{wV:OY!w_", false);
      rIFClassLoader0.clearAssertionStatus();
      rIFClassLoader0.clearAssertionStatus();
      rIFClassLoader0.setClassAssertionStatus("", true);
      // Undeclared exception!
      try { 
        rIFClassLoader0.registerClass("^fc$m&Qd4Ka|57^/]N<", byteArray0);
