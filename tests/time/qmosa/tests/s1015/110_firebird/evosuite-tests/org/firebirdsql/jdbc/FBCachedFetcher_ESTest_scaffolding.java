...
public class FBCachedFetcher_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, FBCachedFetcher_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("org.firebirdsql.jdbc.FBObjectListener$ResultSetListener", false, FBCachedFetcher_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.firebirdsql.jdbc.field.FBCachedBlobField", false, FBCachedFetcher_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.firebirdsql.jdbc.field.FBLongVarCharField", false, FBCachedFetcher_ESTest_scaffolding.class.getClassLoader()));
  }
