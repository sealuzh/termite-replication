...
public class ClientMsgReceiver_ESTest extends ClientMsgReceiver_ESTest_scaffolding {
  ...
  */
  ...
  public void test1()  throws Throwable  {
      ...
      SQLInvalidAuthorizationSpecException sQLInvalidAuthorizationSpecException0 = new SQLInvalidAuthorizationSpecException("=b`dckG\"?~{i9z +", "=b`dckG\"?~{i9z +");
      ClientMsgReceiver clientMsgReceiver0 = new ClientMsgReceiver(mockSocket0, (BomberClient) null);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test2()  throws Throwable  {
      MockSocket mockSocket0 = new MockSocket();
      ClientMsgReceiver clientMsgReceiver0 = new ClientMsgReceiver(mockSocket0, (BomberClient) null);
      ArrayList<SessionScoreMsg> arrayList0 = new ArrayList<SessionScoreMsg>();
