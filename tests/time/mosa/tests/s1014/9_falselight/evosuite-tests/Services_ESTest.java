...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      Services.testPOP3("", 0);
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testPOP3("", 2765);
  ...
  */
  ...
  public void test02()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://xDx:0");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "1=Eh4");
      Services.HTTP_Result services_HTTP_Result0 = new Services.HTTP_Result();
      assertEquals(0, services_HTTP_Result0.page_weight);
      assertEquals(0L, services_HTTP_Result0.time);
      assertFalse(services_HTTP_Result0.works);
      ...
      Services.HTTP_Result services_HTTP_Result1 = Services.testHTTPS("xDx", 0);
      assertTrue(services_HTTP_Result1.works);
      assertEquals(6, services_HTTP_Result1.page_weight);
      
      Services.testHTTP("TU,-!T[6", 0);
      Services.testHTTP("** Erreur g\u00E9n\u00E9r\u00E9e : ", 0);
      Services services0 = new Services();
      Services.testPOP3("TU,-!T[6", 0);
      Services.SIMPLE_Result services_SIMPLE_Result1 = Services.testSMTP("TU,-!T[6", 0);
  ...
  */
  ...
  public void test04()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("", (-41));
      assertEquals(0L, services_HTTP_Result0.time);
      assertEquals(0, services_HTTP_Result0.page_weight);
      assertEquals(0, services_HTTP_Result0.code);
      assertFalse(services_HTTP_Result0.works);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("}9B!F", (-2065));
      assertEquals(0L, services_HTTP_Result0.time);
      assertEquals(0, services_HTTP_Result0.page_weight);
      assertFalse(services_HTTP_Result0.works);
      assertEquals(0, services_HTTP_Result0.code);
