...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("?S.*P1fb ]$y-z@bKh!", nucleotideSequence0, qualitySequence0, (Map<String, String>) hashMap1, (List<PhdWholeReadItem>) linkedList0);
      List<PhdWholeReadItem> list0 = artificialPhd0.getWholeReadItems();
      ArtificialPhd.createNewbler454Phd("_", nucleotideSequence0, qualitySequence0, (Map<String, String>) hashMap0, list0);
      ...
      DefaultPhd defaultPhd0 = new DefaultPhd("8", (NucleotideSequence) null, qualitySequence1, (PositionSequence) null, hashMap1, list0, list1);
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("]KHJ", nucleotideSequence0, qualitySequence0, (Map<String, String>) hashMap0);
  ...
  */
  ...
  public void test02()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2271L).when(nucleotideSequence0).getLength();
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(8, 89);
      phdBuilder1.comments(map0);
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(nucleotideSequence1).getLength();
      ArtificialPhd artificialPhd1 = new ArtificialPhd("", nucleotideSequence1, (QualitySequence) null, (-3553));
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      PhdBuilder phdBuilder2 = new PhdBuilder(phd0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder(" `v@h LT7%l7>O", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("<Vvxc(*ka r?bPx", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(19, (-2283));
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      doReturn(2271L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = new ArtificialPhd("org.jcvi.jillion.assembly.consed.phd.PhdBuilder", nucleotideSequence0, qualitySequence0, 178);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ...
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("$Qg", nucleotideSequence0, qualitySequence0, positionSequence0, defaultChannelGroup0);
  ...
  */
  ...
  public void test10()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("LI>Eml", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("_YtoJg4_Jc:CF{BdEjG", nucleotideSequence0, qualitySequence0);
      Phd phd0 = phdBuilder0.build();
      assertEquals("_YtoJg4_Jc:CF{BdEjG", phd0.getId());
  }
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(50L).when(qualitySequence0).getLength();
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
  ...
  */
  ...
  public void test14()  throws Throwable  {
      ...
      doReturn(50L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((-331L)).when(qualitySequence0).getLength();
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("org.jcvi.jillion.assembly.consed.phd.PhdBuilder", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
  ...
  */
  ...
  public void test15()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder(" 43~gMN4ICoT>g&d|", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test16()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(670L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((-689L)).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test20()  throws Throwable  {
      ...
      doReturn(0L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("peaks and qualities have unequal lengths", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test21()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("org.jcvi.jillion.core.Range$CoordinateSystem", nucleotideSequence0, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test24()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(2144380347, 2144380347);
      assertSame(phdBuilder1, phdBuilder0);
  }
  ...
  */
  ...
  public void test25()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("J^1JTq(", nucleotideSequence0, qualitySequence0);
