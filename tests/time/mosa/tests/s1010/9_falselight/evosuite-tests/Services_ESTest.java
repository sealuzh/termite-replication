...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testSMTP("$-n[O[bq@65j|8WN9", 1);
  ...
  */
  ...
  public void test01()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://+OK:954");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ") **");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("+OK", 954);
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "MzK\"&");
  ...
  */
  ...
  public void test03()  throws Throwable  {
      EvoSuiteRemoteAddress evoSuiteRemoteAddress0 = new EvoSuiteRemoteAddress("0.0.0.220", 730);
      NetworkHandling.openRemoteTcpServer(evoSuiteRemoteAddress0);
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testPOP3("220", 730);
      assertEquals(0L, services_SIMPLE_Result0.time);
      assertFalse(services_SIMPLE_Result0.works);
  }
  ...
  */
  ...
  public void test04()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://<qC@(?.Z^|y%$[x>v:0");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "[Rj?'&?>pv&u>");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("<qC@(?.Z^|y%$[x>v", 0);
      assertTrue(services_HTTP_Result0.works);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS((String) null, (-998));
      assertEquals(0, services_HTTP_Result0.code);
      assertEquals(0L, services_HTTP_Result0.time);
      assertEquals(0, services_HTTP_Result0.page_weight);
      assertFalse(services_HTTP_Result0.works);
  ...
  */
  ...
  public void test06()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("@Pmg@PV&ELZ,en", (-1460));
      assertEquals(0L, services_HTTP_Result0.time);
      assertFalse(services_HTTP_Result0.works);
      assertEquals(0, services_HTTP_Result0.code);
      assertEquals(0, services_HTTP_Result0.page_weight);
  ...
  */
  ...
  public void test10()  throws Throwable  {
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testSMTP((String) null, (-37));
      assertEquals(0L, services_SIMPLE_Result0.time);
      assertFalse(services_SIMPLE_Result0.works);
  }
  ...
  */
  ...
  public void test15()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("@Pmg@PV&ELZ,en", (-1443));
      assertFalse(services_HTTP_Result0.works);
      assertEquals(0, services_HTTP_Result0.page_weight);
      assertEquals(0, services_HTTP_Result0.code);
      assertEquals(0L, services_HTTP_Result0.time);
