...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      EvoSuiteRemoteAddress evoSuiteRemoteAddress0 = new EvoSuiteRemoteAddress("127.0.0.1", 970);
      NetworkHandling.openRemoteTcpServer(evoSuiteRemoteAddress0);
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testSMTP("", 970);
      assertEquals(0L, services_SIMPLE_Result0.time);
      assertFalse(services_SIMPLE_Result0.works);
      
      NetworkHandling.createRemoteTextFile((EvoSuiteURL) null, "");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("**Erreur : java.lang.NullPointerException**", (-2285));
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      Services.HTTP_Result services_HTTP_Result0 = new Services.HTTP_Result();
      EvoSuiteRemoteAddress evoSuiteRemoteAddress0 = new EvoSuiteRemoteAddress("127.0.0.1", 33);
      NetworkHandling.openRemoteTcpServer(evoSuiteRemoteAddress0);
      String string0 = services_HTTP_Result0.toString();
      assertEquals("**** Resultat : \n** Fonctionnement : false\n** Temps : 0 ms\n** Poid de la page : 0 octets\n** Code de page : 0\n** Erreur g\u00E9n\u00E9r\u00E9e : .\n****", string0);
      
      Services.HTTP_Result services_HTTP_Result1 = Services.testHTTP("", 0);
      assertEquals(33, services_HTTP_Result1.page_weight);
      assertTrue(services_HTTP_Result1.works);
      
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testPOP3("", 33);
      assertEquals(0L, services_SIMPLE_Result0.time);
      assertFalse(services_SIMPLE_Result0.works);
  }
  ...
  */
  ...
  public void test03()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://;'b9l:909");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, ";'b9l");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS(";'b9l", 909);
      String string0 = services_HTTP_Result0.toString();
      assertEquals("**** Resultat : \n** Fonctionnement : true\n** Temps : 0 ms\n** Poid de la page : 6 octets\n** Code de page : -1\n** Erreur g\u00E9n\u00E9r\u00E9e : .\n****", string0);
  }
  ...
  */
  ...
  public void test08()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP(";'b9l", (-1684));
      assertEquals(0L, services_HTTP_Result0.time);
      assertEquals(0, services_HTTP_Result0.page_weight);
      assertFalse(services_HTTP_Result0.works);
      assertEquals(0, services_HTTP_Result0.code);
