...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test05()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      MockFile.createTempFile("j)~fL", "j)~fL", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder(mockFile0);
      MockFile.createTempFile("j)~fL", "j)~fL", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.getNextFile();
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = MockFile.createTempFile("e\"<ZA5", "e\"<ZA5");
  ...
  */
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("3lUD..`'WlUk>ZB(i1", ".Fn:-y8a_xt%}");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder(mockFile0);
      MockFile.createTempFile(".Fn:-y8a_xt%}", ".Fn:-y8a_xt%}", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
