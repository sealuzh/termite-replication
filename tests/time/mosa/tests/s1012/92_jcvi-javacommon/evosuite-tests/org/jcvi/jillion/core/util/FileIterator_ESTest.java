...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("KD0K7P", "KD0K7P");
      File file0 = MockFile.createTempFile("KD0K7P", "KD0K7P", (File) mockFile0);
  ...
  */
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile("KD.K73", "org.jcvi.jillion.core.util.MultipleFileFilter");
      File file0 = MockFile.createTempFile("org.jcvi.jillion.core.util.MultipleFileFilter", "KD.K73", (File) mockFile0);
      file0.setReadOnly();
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file1 = fileIterator0.next();
  ...
  */
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("KD.K73", "org.jcvi.jillion.core.util.MultipleFileFilter");
      MockFile.createTempFile("org.jcvi.jillion.core.util.MultipleFileFilter", "KD.K73", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      MockFile.createTempFile("gqkUnO ", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.getNextFile();
      assertNotNull(file0);
      assertEquals("gqkUnO 0", file0.getName());
  }
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      MockFile mockFile1 = new MockFile(":E/Pm6Vqr6K", ":E/Pm6Vqr6K");
  ...
  */
  ...
  public void test15()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      MockFile mockFile1 = new MockFile("I> (C)Ji4", "");
  ...
  */
  ...
  public void test17()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      MockFile.createTempFile(".Hab,iP;", ".Hab,iP;", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
