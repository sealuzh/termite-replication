...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("<S)K4YEq9i/@(%/<S)K4YEq9i/@(%0<S)K4YEq9i/@(%");
      ...
      File file0 = MockFile.createTempFile("<S)K4YEq9i/@(%", "<S)K4YEq9i/@(%", (File) mockFile1);
  ...
  */
  ...
  public void test01()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("<S)K4YEq9i/@(%/<S)K4YEq9i/@(%");
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      MockFile.createTempFile(".9($jiZV:$", "org.jcvi.jillion.core.util.LIFOQueue", (File) mockFile0);
  ...
  */
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("{OpQ)Rv*yR");
      File file0 = MockFile.createTempFile("{OpQ)Rv*yR", "{OpQ)Rv*yR", (File) mockFile0);
      ...
      File file1 = fileIterator0.next();
      assertEquals("/home/ubuntu/termite/projects/92_jcvi-javacommon/{OpQ)Rv*yR", file1.getParent());
  }
  ...
  */
  ...
  public void test05()  throws Throwable  {
      MockFile mockFile0 = new MockFile("vVog|");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("vVog|/vVog|0vVog|");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "vVog|");
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      mockFile0.mkdirs();
      mockFile0.setReadable(true, true);
      MockFile.createTempFile("<S)K4YEq9i/@(%", "fileFilter can not be null", (File) mockFile0);
  ...
  */
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("z6P(hi<(");
      MockFile mockFile1 = new MockFile(mockFile0, "");
      mockFile1.setReadOnly();
      MockFile.createTempFile("z6P(hi<(", "z6P(hi<(", (File) mockFile1);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("{OpQ)Rv*yR");
      MockFile.createTempFile("{OpQ)Rv*yR", "{OpQ)Rv*yR", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test12()  throws Throwable  {
      ...
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.next();
      assertEquals("/home/ubuntu/termite/projects/92_jcvi-javacommon/{OpQ)Rv*yR", file0.getParent());
  }
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      MockFile mockFile2 = new MockFile("org.jcvi.jillion.core.util.iter.IteratorUtil$EmptyIterator");
      MockFile.createTempFile("org.jcvi.jillion.core.util.iter.IteratorUtil$EmptyIterator", "lA+Ms>", (File) mockFile1);
  ...
  */
  ...
  public void test17()  throws Throwable  {
      ...
      MockFile.createTempFile("Vg|", "Vg|", (File) mockFile0);
  ...
  */
  ...
  public void test18()  throws Throwable  {
      MockFile mockFile0 = new MockFile("{pQ)R|*DR");
      MockFile.createTempFile("{pQ)R|*DR", "{pQ)R|*DR", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      LinkedList<FileFilter> linkedList0 = new LinkedList<FileFilter>();
      MultipleFileFilter multipleFileFilter0 = new MultipleFileFilter(linkedList0);
  ...
  */
  ...
  public void test24()  throws Throwable  {
      MockFile mockFile0 = new MockFile("org.jcvi.jillion.core.util.FileIterator$NonRcursiveFileIterator");
      mockFile0.mkdirs();
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      Iterator<File> iterator0 = fileIterator0.iterator();
  ...
  */
  ...
  public void test25()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Nb.(<{{<}e[KjGIOi");
      MockFile.createTempFile("Nb.(<{{<}e[KjGIOi", "Nb.(<{{<}e[KjGIOi", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileFilter[] fileFilterArray0 = new FileFilter[9];
      MultipleFileFilter multipleFileFilter0 = new MultipleFileFilter(fileFilterArray0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.fileFilter(multipleFileFilter0);
  ...
  */
  ...
  public void test27()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      MockFile mockFile1 = new MockFile("65>_&", "65>_&");
  ...
  */
  ...
  public void test30()  throws Throwable  {
      MockFile mockFile0 = new MockFile("vVog|", "vVog|");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder(mockFile0);
      // Undeclared exception!
      try { 
        fileIterator_FileIteratorBuilder0.build();
