...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("v1>+cA]uM");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      MockFile.createTempFile("v1>+cA]uM", "v1>+cA]uM", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.next();
      assertEquals("v1>+cA]uM0v1>+cA]uM", file0.getName());
  }
  ...
  */
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      MockFile.createTempFile("org.jcvi.jillion.core.util.LIFOQueue", "org.jcvi.jillion.core.util.LIFOQueue");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.getNextFile();
      assertEquals("/tmp/org.jcvi.jillion.core.util.LIFOQueue0org.jcvi.jillion.core.util.LIFOQueue", file0.toString());
      assertNotNull(file0);
  }
  ...
  */
  ...
  public void test12()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = MockFile.createTempFile("4)o-.A'm=f#`1;P`", "4)o-.A'm=f#`1;P`", (File) mockFile0);
  ...
  */
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("89i6|O!cU10@fSB.");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      // Undeclared exception!
      try { 
        fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      MockFile.createTempFile(".CN(", "org.jcvi.jillion.core.util.iter.IteratorUtil$EmptyIterator", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
