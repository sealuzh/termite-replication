...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/foo.bar/fz~&@qhd>|@{gE$08AWn@n~jXAK#oo~");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "fz~&@qhd>|@{gE$");
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      fileIterator0.next();
  ...
  */
  ...
  public void test03()  throws Throwable  {
      MockFile mockFile0 = new MockFile("C\" tk 57xd(d?['z1", "C\" tk 57xd(d?['z1");
      MockFile.createTempFile("org.jcvi.jillion.core.util.FileIterator$NonRecursiveFileIteratorBuilder", "C\" tk 57xd(d?['z1", (File) mockFile0);
      MockFile.createTempFile("C\" tk 57xd(d?['z1", "C\" tk 57xd(d?['z1", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      File file0 = fileIterator0.getNextFile();
      assertEquals("org.jcvi.jillion.core.util.FileIterator$NonRecursiveFileIteratorBuilder0C\" tk 57xd(d?['z1", file0.getName());
  }
  ...
  */
  ...
  public void test05()  throws Throwable  {
      MockFile mockFile0 = new MockFile("no elemen*s)iE empty iterator");
      MockFile mockFile1 = new MockFile("no elemen*s)iE empty iterator", "no elemen*s)iE empty iterator");
      mockFile1.mkdirs();
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.includeHiddenFiles(true);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder2 = fileIterator_FileIteratorBuilder1.includeDirectories(true);
  ...
  */
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "0xC(vLoO6y2\"Vht&");
  ...
  */
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("no elemen*s)iE empty iterator");
      MockFile.createTempFile("no elemen*s)iE empty iterator", "no elemen*s)iE empty iterator", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test11()  throws Throwable  {
      MockFile mockFile0 = new MockFile("no elemen*s)iE empty iterator", "no elemen*s)iE empty iterator");
      File file0 = MockFile.createTempFile("no elemen*s)iE empty iterator", "no elemen*s)iE empty iterator", (File) mockFile0);
      file0.delete();
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("C\" tk 57xd(d?['z1", "C\" tk 57xd(d?['z1");
      File file0 = MockFile.createTempFile("C\" tk 57xd(d?['z1", "C\" tk 57xd(d?['z1", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      mockFile0.toURI();
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test18()  throws Throwable  {
      ...
      MockFile.createTempFile("/tmp/foo.bar", "/tmp/foo.bar", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test21()  throws Throwable  {
      MockFile mockFile0 = new MockFile("no elemen*s in empty iterator", "no elemen*s in empty iterator");
      MockFile mockFile1 = new MockFile("no elemen*s in empty iterator", "no elemen*s in empty iterator");
      mockFile1.mkdirs();
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      Iterator<File> iterator0 = fileIterator0.iterator();
  ...
  */
  ...
  public void test23()  throws Throwable  {
      URI uRI0 = MockURI.aFileURI;
      MockFile mockFile0 = new MockFile(uRI0);
      File file0 = MockFile.createTempFile("fz~&@qhd>|@{gE$", "fz~&@qhd>|@{gE$", (File) mockFile0);
