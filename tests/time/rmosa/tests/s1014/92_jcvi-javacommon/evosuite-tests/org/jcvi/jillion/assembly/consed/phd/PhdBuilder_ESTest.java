...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(735L, 0L).when(nucleotideSequence0).getLength();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      LinkedList<PhdWholeReadItem> linkedList0 = new LinkedList<PhdWholeReadItem>();
      QualitySequence qualitySequence0 = null;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("", nucleotideSequence0, (QualitySequence) null, (Map<String, String>) hashMap0, (List<PhdWholeReadItem>) linkedList0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      int int0 = 15;
      String string0 = "";
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(nucleotideSequence1).getLength();
      ArtificialPhd.createNewbler454Phd("=o&4?0s", nucleotideSequence1, (QualitySequence) null, (Map<String, String>) hashMap0);
      phdBuilder0.fakePeaks(1, 15);
      phdBuilder0.build();
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder("F|d+R", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      DefaultPhd defaultPhd0 = new DefaultPhd("", nucleotideSequence0, (QualitySequence) null, (PositionSequence) null, (Map<String, String>) null);
  ...
  */
  ...
  public void test04()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1168L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("VNiZ", nucleotideSequence0, qualitySequence0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      ...
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("VNiZ", nucleotideSequence0, qualitySequence0, positionSequence0, defaultChannelGroup0);
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      LinkedList<PhdWholeReadItem> linkedList0 = new LinkedList<PhdWholeReadItem>();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("VNiZ", nucleotideSequence0, qualitySequence0, (Map<String, String>) hashMap0, (List<PhdWholeReadItem>) linkedList0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      int int0 = 15;
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1168L).when(nucleotideSequence1).getLength();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd.createNewbler454Phd("", nucleotideSequence1, qualitySequence1, (Map<String, String>) hashMap0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      // Undeclared exception!
      try { 
        phdBuilder0.peaks(positionSequence0);
  ...
  */
  ...
  public void test08()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(735L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(735L).when(qualitySequence0).getLength();
  ...
  */
  ...
  public void test10()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("NotGuanine", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("&.Mvl+:`,v~kq^e:a'", nucleotideSequence0, qualitySequence0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(1366, (-248));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(2145988185, 2145988185);
      Phd phd0 = phdBuilder1.build();
      assertEquals("phd to copy can not be null", phd0.getId());
  }
  ...
  */
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals("~J@_ H*c", phd0.getId());
  }
  ...
  */
  ...
  public void test15()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("&.Mvl+:`,v~kq^e:a'", nucleotideSequence0, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("A&9]TGrb*gJ:x", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(1565, 1);
      assertSame(phdBuilder1, phdBuilder0);
  }
  ...
  */
  ...
  public void test17()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("-Z8CBLSM5\"ZW|", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test18()  throws Throwable  {
      ...
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(190, 190);
      assertSame(phdBuilder0, phdBuilder1);
  }
  ...
  */
  ...
  public void test19()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("&.Mvl+:`,v~kq^e:a'", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("&.Mvl+:`,v~kq^e:a'", (NucleotideSequence) null, qualitySequence0);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test25()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("nJ]J:CRI", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
