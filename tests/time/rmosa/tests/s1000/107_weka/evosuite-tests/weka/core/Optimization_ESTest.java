...
public class Optimization_ESTest extends Optimization_ESTest_scaffolding {
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      assertArrayEquals(new double[] {Double.NaN, Double.NaN, 0.0, Double.POSITIVE_INFINITY}, doubleArray1, 0.01);
  }
  ...
  */
  ...
  public void test03()  throws Throwable  {
      weka.core.matrix.Matrix matrix0 = new weka.core.matrix.Matrix(2785, 8);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      weka.core.matrix.Matrix matrix0 = new weka.core.matrix.Matrix(2785, 2785);
      double[] doubleArray0 = new double[0];
  ...
  */
  ...
  public void test14()  throws Throwable  {
      Optimization optimization0 = mock(Optimization.class, CALLS_REAL_METHODS);
      weka.core.matrix.Matrix.random(8, 8);
      double[] doubleArray0 = new double[7];
      weka.core.matrix.Matrix matrix0 = new weka.core.matrix.Matrix(8, 8);
      matrix0.clone();
      Optimization.solveTriangle(matrix0, doubleArray0, true, (boolean[]) null);
      int int0 = 1048;
      Optimization.DynamicIntArray optimization_DynamicIntArray0 = optimization0.new DynamicIntArray(1048);
      // Undeclared exception!
      try { 
        optimization_DynamicIntArray0.removeElementAt(102);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
