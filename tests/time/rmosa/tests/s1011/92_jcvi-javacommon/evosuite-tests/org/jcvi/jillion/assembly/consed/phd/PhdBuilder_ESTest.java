...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(315L).when(nucleotideSequence0).getLength();
      ...
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("@7S\"qqRgdz1M", nucleotideSequence0, qualitySequence0, positionSequence0, defaultChannelGroup0, map0);
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("92%P`:W&Q_", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-2119951805), (-2119951805));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("cQ<C!", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("tsvDyb*0 C$Y[", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test08()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(65531L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("org.jcvi.jillion.core.Range$EmptyLongRange", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test09()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      DefaultPhd defaultPhd0 = new DefaultPhd("x", nucleotideSequence0, qualitySequence0, (PositionSequence) null, (Map<String, String>) null);
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("@7S\"qqRgdz1M", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(452, 452);
      Phd phd0 = phdBuilder1.build();
      assertEquals("@7S\"qqRgdz1M", phd0.getId());
  }
  ...
  */
  ...
  public void test12()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2494L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2494L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("'h#ze}klC;lgh`k", nucleotideSequence0, qualitySequence0);
      Phd phd0 = phdBuilder0.build();
      assertEquals("'h#ze}klC;lgh`k", phd0.getId());
  }
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(Integer.MAX_VALUE, (-224));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test15()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1972L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("'h#ze}kC;lgh`k", nucleotideSequence0, qualitySequence0, (Map<String, String>) null);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1972L).when(nucleotideSequence1).getLength();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(1972L, 1972L).when(qualitySequence1).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("'h#ze}kC;lgh`k", nucleotideSequence1, qualitySequence1);
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      doReturn(1972L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("'h#ze}klC;lgh`k", nucleotideSequence0, qualitySequence0, (Map<String, String>) null);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2494L).when(nucleotideSequence1).getLength();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2494L, 2494L).when(qualitySequence1).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("'h#ze}klC;lgh`k", nucleotideSequence1, qualitySequence1);
      // Undeclared exception!
      try { 
        phdBuilder0.peaks(positionSequence0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test17()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("Qa|", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test19()  throws Throwable  {
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      DefaultPhd defaultPhd0 = new DefaultPhd("Z_KSjeoj[|n^>Y", (NucleotideSequence) null, qualitySequence0, (PositionSequence) null);
  ...
  */
  ...
  public void test21()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("l>*B", nucleotideSequence0, qualitySequence0);
        fail("Expecting exception: IllegalArgumentException");
