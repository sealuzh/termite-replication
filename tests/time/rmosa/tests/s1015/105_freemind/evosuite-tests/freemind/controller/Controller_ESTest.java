...
public class Controller_ESTest extends Controller_ESTest_scaffolding {
  ...
  */
  ...
  public void test3()  throws Throwable  {
      JCheckBoxMenuItem jCheckBoxMenuItem0 = new JCheckBoxMenuItem("-Pj<JLrFvVi}S>(pY");
      Color color0 = Color.BLUE;
      try { 
        Controller.showCommonJColorChooserDialog(jCheckBoxMenuItem0, "-Pj<JLrFvVi}S>(pY", color0);
