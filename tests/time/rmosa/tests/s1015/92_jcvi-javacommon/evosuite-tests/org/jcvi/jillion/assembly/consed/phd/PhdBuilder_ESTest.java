...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      ArtificialPhd artificialPhd0 = new ArtificialPhd(" f\"+DET", nucleotideSequence0, qualitySequence0, 2841);
  ...
  */
  ...
  public void test02()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(960L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(960L).when(qualitySequence0).getLength();
      ...
      doReturn(960L, 960L, 960L, 960L).when(qualitySequence1).getLength();
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("BYTE", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test04()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(960L, 960L, 960L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(960L, 960L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("", nucleotideSequence0, qualitySequence0);
      ...
      doReturn((long)14).when(nucleotideSequence1).getLength();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      phdBuilder2.build();
  ...
  */
  ...
  public void test08()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1057L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("jYX`p#+p32MmlqP", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
  }
  ...
  */
  ...
  public void test10()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("iVOs\"V?:8v@", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test11()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(235L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(1321L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(2078209981, 2078209981);
      phdBuilder1.build();
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("`Z'=N^ ", nucleotideSequence0, qualitySequence0);
      LinkedList<PhdReadTag> linkedList0 = new LinkedList<PhdReadTag>();
  ...
  */
  ...
  public void test22()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("@8SsU;Y`OUEE", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(1438, 19);
      assertSame(phdBuilder0, phdBuilder1);
  }
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(1978, (-2381));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test24()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("8w0U[?_+C7z5YP4<%H", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
