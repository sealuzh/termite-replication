...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn((long)(-1066)).when(qualitySequence0).getLength();
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("aXhfQeR!PZE]~", nucleotideSequence0, qualitySequence0, map0);
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("al~=>Q({CRYAAc[cR", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-514), (-514));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("^aV", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test12()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("uzjsg}Gwo{U;E!Okt", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(19, 19);
      Phd phd0 = phdBuilder1.build();
      assertEquals("uzjsg}Gwo{U;E!Okt", phd0.getId());
  }
  ...
  */
  ...
  public void test13()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("D.*pb;4&47!mbfAp(", nucleotideSequence0, qualitySequence0);
      Phd phd0 = phdBuilder0.build();
      assertEquals("D.*pb;4&47!mbfAp(", phd0.getId());
  }
  ...
  */
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(1954, (-5573));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      doReturn((long)19).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((long)87).when(qualitySequence0).getLength();
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("aXhfQeR!PZE]~", nucleotideSequence0, qualitySequence0, map0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
  ...
  */
  ...
  public void test17()  throws Throwable  {
      ...
      doReturn((long)19).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((long)19).when(qualitySequence0).getLength();
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("aXhfQek!PZE]~", nucleotideSequence0, qualitySequence0, map0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
  ...
  */
  ...
  public void test18()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(189L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(189L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("Tkmk", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test20()  throws Throwable  {
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      DefaultPhd defaultPhd0 = new DefaultPhd("vJu", (NucleotideSequence) null, qualitySequence0, (PositionSequence) null);
      PhdBuilder phdBuilder0 = new PhdBuilder(defaultPhd0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(2146962509, 2146962509);
      // Undeclared exception!
      try { 
        phdBuilder1.build();
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test22()  throws Throwable  {
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((-1572L)).when(qualitySequence0).getLength();
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(nucleotideSequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("D.*pb;4&47!mbfAp(", nucleotideSequence0, qualitySequence0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test27()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("VhjA m,D7/", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test29()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("IG{u\"=wt2N", nucleotideSequence0, qualitySequence0);
      LinkedList<PhdWholeReadItem> linkedList0 = new LinkedList<PhdWholeReadItem>();
      PhdBuilder phdBuilder1 = phdBuilder0.wholeReadItems(linkedList0);
      assertSame(phdBuilder1, phdBuilder0);
  }
