...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test02()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(4283L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd(".-ik/Rt;20h3zOS", nucleotideSequence0, qualitySequence0, (Map<String, String>) null);
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("TYC1]_]L058]d+", nucleotideSequence0, qualitySequence0, map0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("byte array can not be null", nucleotideSequence0, qualitySequence0, positionSequence0, defaultChannelGroup0);
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      doReturn(1279L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(4283L).when(qualitySequence0).getLength();
      Map<String, String> map0 = ZoneId.SHORT_IDS;
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = new PhdBuilder("`vf\"+]ISV:<51@O", nucleotideSequence0, qualitySequence0);
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(561, (-2546));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("Cytosine", phd0.getId());
  }
  ...
  */
  ...
  public void test10()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1449L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test18()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("pzYlQyXKiHc/", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test19()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("NhHvMM?Yy", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test21()  throws Throwable  {
      ...
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("", nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(15, 2146377837);
      assertSame(phdBuilder1, phdBuilder0);
  }
  ...
  */
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks((-4430), (-3858));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test24()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("f'1MlbCii9|vgG]V+", nucleotideSequence0, qualitySequence0);
