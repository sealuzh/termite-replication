...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      doReturn(1098L).when(nucleotideSequence0).getLength();
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      doReturn(2777L).when(qualitySequence0).getLength();
  ...
  */
  ...
  public void test02()  throws Throwable  {
      ...
      BasicChromatogram basicChromatogram0 = new BasicChromatogram("peak spacing must be >0", nucleotideSequence1, qualitySequence2, positionSequence0, defaultChannelGroup0, map0);
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      doReturn(1098L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(1098L).when(qualitySequence0).getLength();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd((String) null, nucleotideSequence0, qualitySequence0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
  ...
  */
  ...
  public void test05()  throws Throwable  {
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      DefaultPhd defaultPhd0 = new DefaultPhd("@]orkC@`%YA", (NucleotideSequence) null, qualitySequence0, (PositionSequence) null, map0);
  ...
  */
  ...
  public void test06()  throws Throwable  {
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      DefaultPhd defaultPhd0 = new DefaultPhd("@]orkC@`%YA", (NucleotideSequence) null, (QualitySequence) null, (PositionSequence) null, (Map<String, String>) null);
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder(".8LGZ^+$X-RD", nucleotideSequence0, qualitySequence0);
  ...
  */
  ...
  public void test09()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn((-2147483656L)).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((-2147483594L)).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
  ...
  */
  ...
  public void test15()  throws Throwable  {
      ...
      PhdBuilder phdBuilder1 = phdBuilder0.fakePeaks(1251, 3897);
      assertSame(phdBuilder0, phdBuilder1);
  }
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(2456, (-488));
        fail("Expecting exception: IllegalArgumentException");
