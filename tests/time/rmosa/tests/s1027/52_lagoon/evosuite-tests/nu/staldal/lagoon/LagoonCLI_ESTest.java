...
public class LagoonCLI_ESTest extends LagoonCLI_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      ...
      EvoSuiteFile evoSuiteFile1 = new EvoSuiteFile("Syntax:\nnu.staldal.lagoon.LagoonCLI <property_file> [<interval>|build|force]\nnu.staldal.lagoon.LagoonCLI <sitemap_file> [<interval>|build|force]");
      FileSystemHandling.appendLineToFile(evoSuiteFile1, "Syntax:\nnu.staldal.lagoon.LagoonCLI <property_file> [<interval>|build|force]\nnu.staldal.lagoon.LagoonCLI <sitemap_file> [<interval>|build|force]");
  ...
  */
  ...
  public void test01()  throws Throwable  {
      String[] stringArray0 = new String[1];
      stringArray0[0] = "Syntax:\nnu.stalal.lagoon.LagoonCLI <property_file> [<interval>|build|force]\nnu.staldal.lagoon.LagoonCLI <sitemap_file> [<interval>|build|force].xml";
      LagoonCLI.main(stringArray0);
      assertEquals(1, stringArray0.length);
  }
