...
public class DefaultWebSecurityManager_ESTest extends DefaultWebSecurityManager_ESTest_scaffolding {
  ...
  */
  ...
  public void test03()  throws Throwable  {
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager();
      defaultWebSecurityManager0.setSessionMode("jsecurity");
      defaultWebSecurityManager0.setSessionIdCookieMaxAge((-1064));
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      SimplePrincipalCollection simplePrincipalCollection0 = new SimplePrincipalCollection();
      ServletRequest servletRequest0 = mock(ServletRequest.class, new ViolatedAssumptionAnswer());
      doReturn("I[([").when(servletRequest0).getRemoteHost();
      ServletRequestWrapper servletRequestWrapper0 = new ServletRequestWrapper(servletRequest0);
  ...
  */
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionMode("] with encoding '");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid sessionMode [] with encoding '].  Allowed values are public static final String constants in the org.jsecurity.web.DefaultWebSecurityManager class: 'http' or 'jsecurity', with 'http' being the default.
         //
         verifyException("org.jsecurity.web.DefaultWebSecurityManager", e);
      }
  }
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionIdCookieName("X4[2Ig|D [,[H");
        fail("Expecting exception: IllegalStateException");
