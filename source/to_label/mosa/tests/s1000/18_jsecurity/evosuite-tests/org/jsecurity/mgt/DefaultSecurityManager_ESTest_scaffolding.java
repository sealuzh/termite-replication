...
public class DefaultSecurityManager_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jsecurity.mgt.DefaultSecurityManager"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultSecurityManager_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.jsecurity.session.mgt.ImmutableProxiedSession",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.jsecurity.authc.AuthenticationListener", false, DefaultSecurityManager_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultSecurityManager_ESTest_scaffolding.class.getClassLoader()); 
