...
public class DefaultTestCase implements TestCase, Serializable {
	...
	private double coverageEntropy = Double.NaN;
	...
	public double getCoverageEntropy() {
		return this.coverageEntropy;
	}

	/**
	 * Set the coverage entropy for this test case
	 * @param entropy the assigned coverage entropy
	 */
	public void setCoverageEntropy(double entropy) {
		this.coverageEntropy = entropy;
	}
}
