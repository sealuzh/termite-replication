...
public interface TestCase extends Iterable<Statement>, Cloneable, Listenable<Void> {
	...
	/**
	 * Returns the entropy of the test case, calculated according to the paper about readable test case generation
	 * @return the coverage entropy of the test case
	 */
