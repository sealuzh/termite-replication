...
public class TestSuiteWriter implements Opcodes {
    ...
    protected String testToString(int number, int id, ExecutionResult result) {
        ...
        StringBuilder builder = new StringBuilder();
        builder.append(NEWLINE);
        // gio: added information about coverage entropy here
        if (Properties.ENTROPY_COMMENTS || testComment.containsKey(id)) {
            builder.append(METHOD_SPACE+"/**");
            builder.append(NEWLINE);
            builder.append(METHOD_SPACE);
            builder.append("//");
            builder.append(getEntropyInformation(id));
            builder.append(NEWLINE);
            builder.append(METHOD_SPACE);
            builder.append("*/");
            builder.append(NEWLINE);
        } else if (Properties.TEST_COMMENTS || testComment.containsKey(id)) {
            builder.append(METHOD_SPACE);
            builder.append("//");
    ...
    /**
     * When writing out the Junit test file, a test case can have the information about the coverage entropy as a
     * comment
     * @param num the indext of the test case
     * @return the comment reporting the coverage entropy
     */
    @SuppressWarnings("Duplicates")
    protected String getEntropyInformation(int num) {
        ...
        double entropy = test.getCoverageEntropy();
        StringBuilder builder = new StringBuilder();
        builder.append("Test case number: " + num);
        builder.append(NEWLINE);
        builder.append("  /*");
        builder.append("Coverage entropy="+ entropy);
        return builder.toString();
    }
